 ...
 *
 * Minimal JLLKMultiDex capable application. To use the legacy multidex library there is 3 possibility:
 * <ul>
 ...
 * <code>
  protected void attachBaseContext(Context base) {<br>
    ...
    JLLKMultiDex.install(this);
    </code></li>
 *   <ul>
 */
public class JLLKApplication extends Application {
  @Override
